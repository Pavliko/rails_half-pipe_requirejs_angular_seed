...
module.exports = function(grunt) {
  ...
  grunt.registerTask('build:debug', ['clean', 'copy:prepare', 'coffee', 'ngAnnotate','requirejs:debug', 'sass:debug']);
  grunt.registerTask('build:public', ['clean', 'copy:prepare', 'coffee', 'ngAnnotate','requirejs:public', 'sass:public', 'copy:finalize']);
